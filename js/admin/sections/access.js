...
import { $, $$, esc, ico, initials } from "../helpers.js?v=adm-aabdc4b7";
import { setView } from "../view.js?v=adm-aabdc4b7";
import { switchMarkup, toast, confirmModal, formModal, ensureMenuListeners, closeAllMenus } from "../ui.js?v=adm-aabdc4b7";
import { ROLES, roleLabel, canManageUsers } from "../permissions.js?v=adm-aabdc4b7";
