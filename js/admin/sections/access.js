...
import { $, $$, esc, ico, initials } from "../helpers.js?v=adm-f1bd090d";
import { setView } from "../view.js?v=adm-f1bd090d";
import { switchMarkup, toast, confirmModal, formModal, ensureMenuListeners, closeAllMenus } from "../ui.js?v=adm-f1bd090d";
import { ROLES, roleLabel, canManageUsers } from "../permissions.js?v=adm-f1bd090d";
