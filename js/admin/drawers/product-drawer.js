/* ============================================================================
   ...
   ============================================================================ */
import { state, catById, families, typesOf } from "../state.js?v=adm-aabdc4b7";
import { canManagePricing } from "../permissions.js?v=adm-aabdc4b7";
import { PLACEHOLDER, HOME_MAX, GOAL_SUGGESTIONS } from "../config.js?v=adm-aabdc4b7";
import { $, esc, ico } from "../helpers.js?v=adm-aabdc4b7";
import { field, affix, switchRow, switchMarkup, chipTag, bindChips, confirmModal, toast } from "../ui.js?v=adm-aabdc4b7";
import { requestRerender } from "../shell.js?v=adm-aabdc4b7";
import { reloadProducts } from "../data.js?v=adm-aabdc4b7";
import { openImageCropper } from "../image-cropper.js?v=adm-aabdc4b7";
