/* ============================================================================
   ...
   ============================================================================ */
import { state, catById, families, typesOf } from "../state.js?v=adm-922c03ee";
import { canManagePricing } from "../permissions.js?v=adm-922c03ee";
import { PLACEHOLDER, HOME_MAX, GOAL_SUGGESTIONS } from "../config.js?v=adm-922c03ee";
import { $, esc, ico } from "../helpers.js?v=adm-922c03ee";
import { field, affix, switchRow, switchMarkup, chipTag, bindChips, confirmModal, toast } from "../ui.js?v=adm-922c03ee";
import { requestRerender } from "../shell.js?v=adm-922c03ee";
import { reloadProducts } from "../data.js?v=adm-922c03ee";
import { openImageCropper } from "../image-cropper.js?v=adm-922c03ee";
...
export function openProductDrawer(product, opts = {}) {
  ...
  // Recordatorio de QUÉ se está poniendo en precio: nombre + presentación. Los
  // dos viven en la sección 1, así que se refresca mientras se escriben.
  ...
  // offer pill live: entra y sale con transición (ver .ad-pill--offer) para que
